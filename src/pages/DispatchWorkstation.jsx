    ...
    <div className="fixed inset-0 z-50 flex items-end bg-black/40 backdrop-blur-sm">
      <div className="w-full max-h-[85vh] overflow-y-auto rounded-t-2xl bg-slate-900 border-t border-slate-700 p-4">
        ...
        <div className="mt-6 flex gap-2">
          <button className="flex-1 rounded-lg bg-sky-700 px-3 py-2 text-xs font-medium text-slate-50">
            Amend Release
          </button>
          <button className="flex-1 rounded-lg bg-amber-700 px-3 py-2 text-xs font-medium text-slate-50">
            Re‑Plan
          </button>
          <button className="flex-1 rounded-lg bg-rose-700 px-3 py-2 text-xs font-medium text-slate-50">
            Cancel Flight
          </button>
        </div>
      </div>
