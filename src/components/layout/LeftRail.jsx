...
const TECHNICIAN_ITEMS = [
  ...
  { label: '🤖 AI Forecasting', path: '/AIForecasting' },
  { label: '✈️ Boeing AHM', path: '/BoeingAHM' },
  { label: '🌐 Airbus Skywise', path: '/AirbusSkyw' },
...
const DISPATCH_OPS_ITEMS = [
  ...
  { label: '📍 Airport Gate Map', path: '/AirportGateMap' },
