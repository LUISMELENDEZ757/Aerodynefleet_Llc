...
const TECH_CARDS = [
  ...
  { icon: Activity,      iconBg: 'bg-blue-600',   title: 'Fleet Dashboard', subtitle: 'Aircraft Status · Registry',  path: '/FleetDashboard' },
  { icon: Gauge,         iconBg: 'bg-red-600',    title: 'OOS Dashboard',  subtitle: 'Out of Service Aircraft',    path: '/OOSDashboard' },
  { icon: Wrench,        iconBg: 'bg-indigo-600', title: 'Technician Mode', subtitle: 'Logbook · Oil · O2 Service', path: '/TechnicianMode' },
  { icon: Truck,         iconBg: 'bg-cyan-600',   title: 'Ground Ops',     subtitle: 'Turnaround · Pushback',      path: '/GroundOps' },
  ...
  { icon: BarChart3,     iconBg: 'bg-emerald-500',title: 'Engine Health Analytics', subtitle: 'EGT · LLP · Shop Visits', path: '/EngineHealthAnalytics' },
];
